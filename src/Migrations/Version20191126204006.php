 ...
 */
final class Version20191126204006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date_debut VARCHAR(255) DEFAULT NULL, date_fin VARCHAR(255) DEFAULT NULL, owner VARCHAR(255) DEFAULT NULL, client VARCHAR(255) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE comment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, comment VARCHAR(255) DEFAULT NULL, client VARCHAR(255) DEFAULT NULL)');
