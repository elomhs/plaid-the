 ...
 */
final class Version20191122112707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, mdp, comment FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, role_id INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, mdp VARCHAR(255) DEFAULT NULL COLLATE BINARY, comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_C7440455D60322AC FOREIGN KEY (role_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO client (id, name, mdp, comment) SELECT id, name, mdp, comment FROM __temp__client');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__owner AS SELECT id, role_id, firstname, family_name, address, country FROM owner');
        ...
        $this->addSql('INSERT INTO owner (id, role_id, firstname, family_name, address, country) SELECT id, role_id, firstname, family_name, address, country FROM __temp__owner');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, name, mdp, comment FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, mdp VARCHAR(255) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO client (id, name, mdp, comment) SELECT id, name, mdp, comment FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX UNIQ_CF60E67CD60322AC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__owner AS SELECT id, role_id, firstname, family_name, address, country FROM owner');
        $this->addSql('DROP TABLE owner');
        $this->addSql('CREATE TABLE owner (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, role_id INTEGER DEFAULT NULL, firstname VARCHAR(255) NOT NULL, family_name VARCHAR(255) NOT NULL, address CLOB DEFAULT NULL, country VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO owner (id, role_id, firstname, family_name, address, country) SELECT id, role_id, firstname, family_name, address, country FROM __temp__owner');
        $this->addSql('DROP TABLE __temp__owner');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CF60E67CD60322AC ON owner (role_id)');
        $this->addSql('DROP INDEX IDX_729F519B7E3C61F9');
